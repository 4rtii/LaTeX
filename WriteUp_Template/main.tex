...
\newcommand{\machineName}{Preignition}              % Nombre de la máquina
...
\newcommand{\machineIP}{10.22.33.44}                % Dirección ip de la máquina víctima
\newcommand{\machineDiff}{Very easy}                % Dificultad de la máquina víctima
\newcommand{\startDate}{25 de mayo del 2022}        % Fecha
...
\begin{document}
    ...
    \section{Análisis de Vulnerabilidades}
        ...
        \begin{figure}[h]
            \centering
            \includegraphics[width=0.8\textwidth]{img/preignitionPing.png}      % Reconocimiento inicial (ping)
        ...
        \begin{figure}[h]
            \centering
            \includegraphics[width=\textwidth]{img/preignitionNmap.png}     % Escaneo (nmap)
